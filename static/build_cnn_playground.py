"""Assemble cnn_playground.html with both CNN and ViT weights embedded."""
import json
...
html = open('cnn_playground_template.html').read()
...
with open('cnn_playground.html', 'w') as f:
    f.write(html)
print(f'Written cnn_playground.html ({len(html)} bytes)')
